...
-- Crossmint EVM: auto-provisioned gasless smart wallet via Crossmint (crossmintWallet: true, crossmintChain: base)
...
• Request testnet faucet funds (if on testnet)
...
To start: Just hire the agent. The wallet is created automatically on first task.',
    ...
    '["trading","finance","defi","wallet"]',
    '[]',
    '[{"label":"Crossmint Documentation","url":"https://crossmint-crossmint-sdk.mintlify.app/wallets-sdk/evm-wallets"},{"label":"BaseScan Explorer","url":"https://basescan.org"},{"label":"1inch API","url":"https://docs.1inch.io/"}]',
